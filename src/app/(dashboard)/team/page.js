...
import {
  ...
  ChevronRight, Briefcase, Coffee, FileText, Flag, Camera
} from 'lucide-react';
      ...
      {activeTab === 'screenshots' && (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-muted-foreground/60 mt-3 max-w-xs">
              Random screen capture monitoring will be available here. 
              Extension-based, auto-captures every 8–15 minutes during shift.
            </p>
          </div>
          <div className="flex items-center gap-2 mt-2 px-4 py-2 bg-muted/40 rounded-full">
